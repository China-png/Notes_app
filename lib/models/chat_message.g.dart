...
void _chatMessageSerialize(
  ...
  writer.writeLong(offsets[4], object.tokensUsed);
}
...
ChatMessage _chatMessageDeserialize(
  ...
  final object = ChatMessage(
    ...
    sessionId: reader.readLong(offsets[2]),
    timestamp: reader.readDateTime(offsets[3]),
    tokensUsed: reader.readLongOrNull(offsets[4]),
  );
  return object;
}
...
extension ChatMessageQuerySortBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByTokensUsed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tokensUsed', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> sortByTokensUsedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQuerySortThenBy
  ...
  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByTokensUsed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tokensUsed', Sort.asc);
    });
  }

  QueryBuilder<ChatMessage, ChatMessage, QAfterSortBy> thenByTokensUsedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'tokensUsed', Sort.desc);
    });
  }
...
extension ChatMessageQueryWhereDistinct
  ...
  QueryBuilder<ChatMessage, ChatMessage, QDistinct> distinctByTokensUsed() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatMessageQueryProperty
  ...
  QueryBuilder<ChatMessage, int?, QQueryOperations> tokensUsedProperty() {
    return QueryBuilder.apply(this, (query) {
